  ...
  <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      ...
      <form class="mt-8 space-y-6" @submit.prevent="invokeReset">
        <div class="text-red-600 focus:ring-brand-primary border-gray-300 rounded" v-if="state.error">{{ state.error }}
        </div>
        ...
        <div class="-space-y-px">
          ...
          <div>
            <label for="confirm-password" class="sr-only">Repeat Password</label>
            <input id="confirm-password" v-model="state.password.newPasswordConfirm" name="confirm-password"
              type="password" autocomplete="repeat-password" required
        ...
        <div>
          <button
            ...
            <span class="absolute left-0 inset-y-0 flex items-center pl-3">
              ...
              <svg class="h-5 w-5 text-brand-primary group-hover:text-brand-light" xmlns="http://www.w3.org/2000/svg"
