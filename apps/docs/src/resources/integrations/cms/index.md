...
If Shopware should remain the primary router, use the [Multiple CMS](../../../getting-started/cms/multiple-cms)
...
- [Multiple CMS](../../../getting-started/cms/multiple-cms): render an external
  CMS as a fallback next to Shopware Shopping Experiences.
- [Shopping Experiences](../../../framework/shopping-experiences): customize the
