...
<!-- automd:file src="examples/docs-code-examples/src/generated/guides/e-commerce/json-ld/json-ld-in-vue-demo-store.txt" code lang="ts" no-name -->
...
<!-- automd:file src="examples/docs-code-examples/src/generated/guides/e-commerce/json-ld/extending.txt" code lang="ts" no-name -->
