...
head:
  ...
  - - meta
    - name: og:description
      content: "Shopware Composable Frontends offers two shortcuts to getting started with your custom frontend. These so-called templates offer different levels of 'completeness' of a project."
  - - meta
    - name: og:image
...
Shopware Composable Frontends offers shortcuts to getting started with your custom frontend. These so-called templates offer different levels of "completeness" of a project.

:::tip HINT 💡
You can also integrate Shopware Composable Frontends as an **npm package** into your existing [custom Javascript project](./templates/custom-project).
:::
...
If you like to start from scratch, you can use the blank template. It can be handy if you want to use a different CSS framework or create a completely new frontend, but leverage the built-in functionality of all Shopware Composable Frontends packages.
...
It is possible to integrate Shopware Composable Frontends into an existing project. As of now, only Vue.js projects are supported.
...
<PageRef page="./templates/custom-project" title="Custom Project" sub="Integrate Shopware Composable Frontends into an existing Vue.js project" />

## Framework supporting Vue

In theory, every place where the Vue instance is available, is supported by Shopware Composable Frontends too.
...
<PageRef page="./templates/astro-template" title="Astro.js project" sub="Integrate Shopware Composable Frontends into an SSR oriented project supporting Vue.js" />
