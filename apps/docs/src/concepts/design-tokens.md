...
Templates like the [Vue Starter Template](../introduction/templates/vue-starter-template) and its [extended variant](../introduction/templates/vue-starter-template-extended) consume these tokens out of the box by extending the design-tokens layer.
