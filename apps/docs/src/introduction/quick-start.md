...
:::tip
See the [Vue Starter Template Extended](./templates/vue-starter-template-extended.html) example to learn how to use Nuxt layers to extend the base template while keeping your customizations separate.
:::
...
<PageRef page="../concepts/shopping-experiences.html" title="Customize CMS Components" sub="Override CMS components using the cms-base package" />
