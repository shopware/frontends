import { config, setup, update, onConfigChange } from ".";
...
const DEFAULT_ENDPOINT = defaultConfig.endpoint;
...
describe("Settings", () => {
  ...
  describe("createInstance", () => {
    it("should return config proxy", () => {
      const apiInstance = createInstance();
      expect(Object.keys(apiInstance)).toEqual(
