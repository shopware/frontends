/**
 * Theme color constants - Single source of truth for all color values
 * Used in both UnoCSS config and contexts where CSS variables don't work (e.g., SVG data URIs)
 */
