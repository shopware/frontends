...
export type Schemas = {
  ...
  ContentDataPage: {
    ...
    /** Element-to-property mappings (elementId => {propKey => refId}) */
    assignments: GenericRecord;
    /** Deduplicated property values (refId => value) */
    data: GenericRecord;
    layoutId: string;
    layoutName: string;
  ...
  ContentDecomposedPage: {
    ...
    layoutName: string;
    layoutVersion?: string | null;
    skeletons: components["schemas"]["ContentElement"][];
  };
  ContentElement: {
    /** @enum {string} */
  ...
  ContentSkeletonPage: {
    ...
    /** Pre-hydration element trees without loaded data */
    elements: components["schemas"]["ContentElement"][];
    layoutId: string;
    layoutName: string;
    layoutVersion?: string | null;
...
export type operations = {
  ...
  "readContentData get /content-data/{path}": {
    contentType?: "application/json";
    accept?: "application/json";
    headers?: {
      /** Instructs Shopware to return the response in the given language. */
    ...
    response: components["schemas"]["ContentDataPage"];
    responseCode: 200;
  };
  "readContentDecomposed get /content-decomposed/{path}": {
    contentType?: "application/json";
    accept?: "application/json";
    headers?: {
      /** Instructs Shopware to return the response in the given language. */
    ...
    response: components["schemas"]["ContentDecomposedPage"];
    responseCode: 200;
  };
  "readContentSkeleton get /content-skeleton/{path}": {
    contentType?: "application/json";
    accept?: "application/json";
    headers?: {
      /** Instructs Shopware to return the response in the given language. */
    ...
    response: components["schemas"]["ContentSkeletonPage"];
    responseCode: 200;
  };
  "readContent get /content/{path}": {
    contentType?: "application/json";
    accept?: "application/json";
    headers?: {
      /** Instructs Shopware to return the response in the given language. */
