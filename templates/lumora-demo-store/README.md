...
Lumora is a demo brand focused on:
- **Clean Ingredients** - Premium, eco-friendly scents
- **Modern Minimal Design** - Contemporary aesthetic
- **Light & Balanced Scents** - Subtle, sophisticated fragrances

## Product Categories

- Candles (10 products)
- Reed Diffusers (10 products)
- Room Sprays (10 products)

## Design & Branding

### Color Palette
- **Brand Primary**: `#543B95` (Deep purple)
- **Brand Secondary**: `#E1D5FF` (Soft lavender)
- Visual style: Minimalist with soft neutral tones and warm daylight aesthetics

### Featured Products
- Soft Ember, Calm Drift, Silent Rose
- Nordic Air, White Orchard, Clean Echo
