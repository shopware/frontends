...
<template>
  <div
    class="p-3 h-14 text-sm flex items-center gap-3 hover:bg-surface-surface-container cursor-pointer transition duration-300 bg-surface-surface"
  >
    <div
      class="rounded-md border-1 border-outline-outline-variant overflow-hidden flex-none"
    >
      <NuxtImg
        ref="imageElement"
        loading="lazy"
    ...
    <div class="flex items-center justify-between overflow-hidden gap-5 grow">
      <div
        ...
        class="text-surface-on-surface-variant whitespace-nowrap overflow-hidden text-ellipsis"
      >
