          ...
          <div class="bg-surface-surface">
                      ...
                      <td colspan="4" class="py-3">
                        ...
                        >
                          <div
                            ...
                            @click="
                              getMediaFileHandler(media.id, media.fileName)
                            "
                          >
            ...
            <div class="mt-8 flex flex-col sm:flex-row justify-between">
              ...
              <div class="w-full sm:w-1/3">
                <div class="bg-surface-surface-container-low p-4 rounded-lg">
                  <h3
                    class="text-lg font-semibold text-surface-on-surface mb-2"
                  >
                  ...
                  <div class="flex justify-between mb-2">
                    ...
                    >
                    <span class="text-sm text-surface-on-surface">
                      <SharedPrice
                        :value="subtotal"
                        class="text-surface-on-surface font-normal"
                  ...
                  >
                    <span
                      class="text-base font-semibold text-surface-on-surface"
                      >{{ $t("account.orderDetails.total") }}</span
                    >
                    <span
                      class="text-base font-semibold text-surface-on-surface"
                    >
